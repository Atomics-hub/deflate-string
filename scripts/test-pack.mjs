...
const consumer = await mkdtemp(join(tmpdir(), 'deflate-string-consumer-'));
...
import * as esm from 'deflate-string';
import {createRequire} from 'node:module';
import {runChecks} from './checks.mjs';
const cjs = createRequire(import.meta.url)('deflate-string');
assert.deepEqual(Object.keys(cjs).sort(), ['DeflateStringError', 'compressToBytes', 'compressToUrl', 'compressToUtf16', 'decompressFromBytes', 'decompressFromUrl', 'decompressFromUtf16']);
